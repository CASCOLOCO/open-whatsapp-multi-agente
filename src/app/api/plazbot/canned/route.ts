...
// GET /api/plazbot/canned?search=xxx
...
// POST /api/plazbot/canned { short_code, content, media }
...
// PUT /api/plazbot/canned { id, content, media }
...
// DELETE /api/plazbot/canned?id=xxx
